...
public class BookShop {
    ...
    public static void main(String[] args) {
        ...
        //1.	(1)의 부분은 BookShop.java에서 입력받은 책 번호에 해당 책을 배열에서 찾아
        //rent메소드가 호출되도록 작성합니다.
        Book number = new Book();
        num= number.rent(books);
...
//       }
    ...
    //(2)의 부분은 메소드의 매개변수로 전달된 배열에 저장된 모든 Book 객체의 정보를 
    //출력할 수 있도록 작성합니다
